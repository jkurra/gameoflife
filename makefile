...
OBJECTS   = src/model/model.o src/view/view.o main.o src/view/gamearea/gamearea.o\
			...
			src/model/gamemodel.o src/model/menumodel.o src/model/prefmodel.o src/engine/idspace.o src/engine/gameengine.o src/engine/node.o src/engine/gamearea1.o src/engine/board.o
